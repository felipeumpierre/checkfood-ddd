...
if [ -f /var/www/conf/nginx/nginx-site.conf ]; then
  cp /var/www/conf/nginx/nginx-site.conf /etc/nginx/sites-available/default.conf
fi

if [ -f /var/www/conf/nginx/nginx-site-ssl.conf ]; then
  cp /var/www/conf/nginx/nginx-site-ssl.conf /etc/nginx/sites-available/default-ssl.conf
fi
